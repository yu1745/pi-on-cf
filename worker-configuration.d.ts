/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b27f2138efb93f4fffbd8fa32e960a83)
...
interface __BaseEnv_Env {
	...
	CF_AI_MODELS: "@cf/zai-org/glm-5,@cf/moonshotai/kimi-k2,@cf/meta/llama-4-scout-17b-16e-instruct,@cf/openai/gpt-oss-120b,@cf/qwen/qwen3-30b-a3b-fp8,@cf/deepseek-ai/deepseek-r1-distill-qwen-32b,@cf/mistralai/mistral-small-3";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_BASE_URL" | "AI_MODEL" | "AI_MEMORY_MODEL" | "COMPUTER_R2_BUCKET" | "CF_AI_MODELS" | "CLOUDFLARE_ACCOUNT_ID" | "AI_API_KEY" | "CF_API_TOKEN">> {}
}
