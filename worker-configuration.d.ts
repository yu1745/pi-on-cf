/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5e2292edd3bf306a8a882ea79b1b86c1)
// Runtime types generated with workerd@1.20260801.1 2026-07-27 nodejs_compat
interface __BaseEnv_Env {
	COMPUTER_R2: R2Bucket;
	AI_BASE_URL: "https://api.deepseek.com";
	AI_MODEL: "deepseek-v4-flash";
	AI_MEMORY_MODEL: "deepseek-v4-flash";
	COMPUTER_R2_BUCKET: "pi-on-cf-computer";
	CF_AI_MODELS: "@cf/meta/llama-4-scout-17b-16e-instruct,@cf/openai/gpt-oss-120b,@cf/openai/gpt-oss-20b,@cf/qwen/qwen3-30b-a3b-fp8,@cf/qwen/qwq-32b,@cf/deepseek-ai/deepseek-r1-distill-qwen-32b";
	SEARCH_BACKEND: "";
	SEARCH_API_URL: "";
	SEARCH_API_KEY: "";
	...
	CF_API_TOKEN: string;
	GIT_TOKEN: string;
	PiSession: DurableObjectNamespace<import("./src/server").PiSession>;
	PiRegistry: DurableObjectNamespace<import("./src/server").PiRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "PiSession" | "PiRegistry";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_BASE_URL" | "AI_MODEL" | "AI_MEMORY_MODEL" | "COMPUTER_R2_BUCKET" | "CF_AI_MODELS" | "SEARCH_BACKEND" | "SEARCH_API_URL" | "SEARCH_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "AI_API_KEY" | "CF_API_TOKEN" | "GIT_TOKEN">> {}
}
